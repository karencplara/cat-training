...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, createdAt: any, description?: string | null, id: string, lessonType: LessonType, slug: string, title: string }> };
